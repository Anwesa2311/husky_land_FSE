...
/***********************************
* This function is responsible for initializing SDL
* and loading the SDL library based on the operating system.
*/
shared static this(){
    ...
    // Initialize SDL2_ttf
    if (TTF_Init() == -1) {
        writeln("error loading TTF library:",  TTF_GetError());
    }
...
/***********************************
* Upon termination, this function automatically called at the end 
* of the program and is responsible for quitting the SDL application.
*/
shared static ~this(){
